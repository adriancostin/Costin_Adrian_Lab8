...
namespace Costin_Adrian_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Costin_Adrian_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Costin_Adrian_Lab8Context context,
